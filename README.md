...
Paste an article link and get an AI-generated summary, key points, tags, and a suggested
category — collected as cards on a topic-organized board.
...
Spec-first, ADR-required for new patterns, retro after every feature. See
[CLAUDE.md](./CLAUDE.md).
